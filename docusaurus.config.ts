...
const config: Config = {
  ...
  tagline: 'A Hands-On Guide to Building AI-Powered Physical Systems and Humanoid Robotics',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          to: '/learning', // Connects to the new learning page
          label: 'learning',
          position: 'left',
        },
