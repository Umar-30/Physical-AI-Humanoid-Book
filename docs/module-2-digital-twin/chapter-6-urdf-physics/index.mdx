...
1. ✅ **Integrate sensors** - Add IMU, cameras, lidar, and force-torque sensors to URDF
2. ✅ **Optimize collision geometry** - Create efficient collision shapes for humanoid robots
3. ✅ **Calculate inertia** - Compute accurate mass and inertia tensors for all links
4. ✅ **Configure joints** - Set limits, friction, damping, and effort constraints
5. ✅ **Validate physics** - Test and verify realistic simulation behavior

## Prerequisites

Before starting this chapter, ensure you have:

- ✅ **Chapter 5 Complete**: Can spawn robots in Gazebo successfully
- ✅ **Module 1 Complete**: Understanding of URDF structure (links, joints, transforms)
- ✅ **Working Gazebo**: Harmonic installation verified and functional
- ✅ **Basic Python**: For inertia calculation scripts (optional but recommended)
...
- ✅ Add 3+ sensor types to a humanoid URDF
- ✅ Optimize collision geometry for 50%+ performance improvement
- ✅ Calculate inertia tensors manually or with scripts
- ✅ Configure joint dynamics for stable walking simulation
...
- ✅ Generic shapes (boxes, cylinders) are highly reusable
- ✅ Similar robot morphologies can share collision templates
- ⚠️ Always adjust mass/inertia for your robot's dimensions
- ❌ Don't reuse without scaling - incorrect mass causes instability
...
- ✅ Good: Simulation runs at real-time factor >0.9 (90% of real-time)
- ⚠️ Moderate: Real-time factor 0.5-0.9 (consider optimization)
- ❌ Poor: Real-time factor &lt;0.5 (definitely simplify)
...
👉 **[Start with Sensor Integration →](./sensor-integration)**

---

## Quick Links

- 📖 [URDF Sensor Plugin Docs](https://classic.gazebosim.org/tutorials?tut=ros_gzplugins)
- 📖 [Gazebo Physics Parameters](https://gazebosim.org/api/sim/8/physics.html)
- ⬅️ [Back to Chapter 5: Gazebo Basics](/docs/module-2-digital-twin/chapter-5-gazebo-basics/chapter-5-overview)
